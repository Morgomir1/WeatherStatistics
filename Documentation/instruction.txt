...
#НАСТРОЙКА БД
#Теперь, необходимо скопировать три файла таблиц: role.csv, admin.csv и statsnew.csv из папки resources проекта, и поместить их в папку /var/lib/mysql-files/
...
LOAD DATA INFILE '/var/lib/mysql-files/statsnew.csv' INTO TABLE weatherstatistics.statsnew FIELDS TERMINATED BY ',' ENCLOSED BY '"'IGNORE 1 ROWS;
#Выходим из mysql
